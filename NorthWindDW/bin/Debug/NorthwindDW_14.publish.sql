...
GO
ALTER TABLE [dbo].[DimEmployee] ALTER COLUMN [TerritoryDescription] NVARCHAR (4000) NOT NULL;
...
GO
ALTER TABLE [staging].[Employee] ALTER COLUMN [TerritoryDescription] NVARCHAR (4000) NOT NULL;
