...
GO
PRINT N'Modificando Tabla [dbo].[DimCustomer]...';


GO
ALTER TABLE [dbo].[DimCustomer] ALTER COLUMN [CustomerID] NCHAR (5) NOT NULL;
...
GO
ALTER TABLE [dbo].[DimEmployee] ALTER COLUMN [Country] NVARCHAR (15) NOT NULL;
